...
def main():
    ...
    # If the model isn't cached yet, let the user pick a size, then download it
    # with a visible progress dialog.
    model_size = whisper.MODEL_SIZE
    if whisper.model_needs_download(model_size):
        print(f"Model '{model_size}' not cached - asking user to choose a size...")
