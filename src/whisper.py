...
SAMPLE_RATE = _env_int("SAMPLE_RATE", 16000, lo=8000)
CHANNELS = _env_int("CHANNELS", 1, lo=1, hi=2)
MAX_RECORDING_SECONDS = _env_int("MAX_RECORDING_SECONDS", 300, lo=1)
...
CPU_THREADS = _env_int("CPU_THREADS", 4, lo=1)
